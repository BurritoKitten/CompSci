/**
 * A PanelDisplay holds the vote counts and
...
public class PanelDisplay extends JPanel
{
  ...
  // Constructor
  public PanelDisplay(String nm1, String nm2, String nm3)
  {
  ...
  {
    double helo = (double)count/total*360;
    return (int) helo;
  }
  ...
  {
	PanelDisplay votingMachine = 
		new PanelDisplay("Tami","Brian","Liz");
	votingMachine.vote1();
	votingMachine.vote2();
	votingMachine.vote2();
